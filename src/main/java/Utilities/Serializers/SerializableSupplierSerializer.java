...
public class SerializableSupplierSerializer<T> implements JsonSerializer<SerializableSupplier<T>>,
        JsonDeserializer<SerializableSupplier<T>>
{
     ...
     */
    @Override
    public JsonElement serialize(SerializableSupplier<T> src, Type typeOfSrc, JsonSerializationContext context)
    {
        ...
        {
            Logger.log("SerializableSupplierSerializer: serialize: Failed to Serialize: " + e);
        }
        return null;
    }
     ...
     */
    @Override
    public SerializableSupplier<T> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws
            JsonParseException
    {
        ...
        {
            return (SerializableSupplier<T>) inputStream.readObject();
        } catch(Exception e)
        {
            Logger.log("SerializableSupplierSerializer: deserialize: Failed to Serialize: " + e);
        }
        return null;
    }
}

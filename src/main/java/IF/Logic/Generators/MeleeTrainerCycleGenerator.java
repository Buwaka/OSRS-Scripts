...
import IF.JFrames.EquipmentConfiguration;
import IF.Logic.Cycles.Combat.SlayerCycle;
import IF.Logic.Tasks.SimpleTasks.Combat.LootAreaTask;
import IF.Logic.Tasks.SimpleTasks.ItemProcessing.InteractInventoryTask;
...
public class MeleeTrainerCycleGenerator implements CycleGenerator
{
    ...
    public static class MeleeTrainerData extends CycleData implements Serializable
    {
        @Serial
        ...
        public List<EquipmentConfiguration.LoadoutEntryWrapper> Loadout = new ArrayList<>();
        public int MinimumGPLoot          = 100;
        public int MinimumGPStackableLoot = 1;
        public boolean                                  PrayBones;
        public Runnable2<SimpleCycle, MeleeTrainerData> ChooseCombatStyle = null;
        public Runnable2<SimpleCycle, MeleeTrainerData> LootKillStyle     = null;
        public Runnable2<SimpleCycle, MeleeTrainerData> ExtraActions      = null;

        public MeleeTrainerData(int att, int str, int def, boolean bones)
        {
            AttackGoal =att;
            StrengthGoal = str;
            DefenceGoal = def;
...
//                stop script
            ...
            var TimeRequirement = 10 mins;
            cycle.AddGoal(new ORRequirement(Goals, TimeRequirement));

...
import IF.Logic.Tasks.AdvanceTasks.SlaughterAndLootTask;
import IF.Logic.Tasks.SimpleTasks.Bank.BankItemsTask;
import IF.Logic.Tasks.SimpleTasks.Bank.GetCombatRationsTask;
import IF.Logic.Tasks.SimpleTasks.Combat.RestoreFullHealthTask;
import IF.Logic.Tasks.SimpleTasks.Misc.EquipmentTask;
import IF.Logic.Tasks.SimpleTasks.TravelTask;
import IF.OSRSDatabase.ItemDB;
import IF.Utilities.Combat.EquipmentManager;
...
public class CombatLootBankCycle extends SimpleCycle
{
    ...
    private final Area[]                                          KillingArea;
    ...
    void StartCycle(IScript Script)
    {
        ...
        Travel1.CompleteCondition = () -> Arrays.stream(KillingArea)
                                                .anyMatch(t -> t.contains(Players.getLocal()
                                                                                 .getTile()));
        SlaughterAndLootTask SALTask = new SlaughterAndLootTask("Killing and Looting",
                                                                KillingArea,
                                                                Targets,
                                                                ItemRequirements);

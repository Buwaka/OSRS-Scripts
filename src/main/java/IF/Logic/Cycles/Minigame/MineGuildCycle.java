...
public class MineGuildCycle extends SimpleCycle
{
    ...
    private void DropInventoryAtBank(IScript Script)
    {
        while(!Bank.isOpen())
        {
            Bank.open();
        ...
        if(Inventory.contains(GemBagID))
        {
            ...
            Script.onGameTicked().WaitRandomTicks(2);
        }
        ...
        Script.onGameTicked().WaitRandomTicks(3);
                ...
                while(!Inventory.isFull())
                {
                    ...
                    if(target == null)
                    {
                        Walking.walk(MineBackupTile);
                         Script.onGameTicked().WaitRandomTicks(6);
                    ...
                    while(target.exists())
                    {
                        ...
                        {
                             Script.onGameTicked().WaitTicks(3);
                        }
                    }
            ...
            case Deposit ->
            {
                ...
                if(Sack != null)
                {
                    while(!Inventory.isFull())
                    {
                        ...
                        Sack.interact();
                         Script.onGameTicked().WaitRandomTicks(5);
     ...
     */
    @Override
    public void onReset(IScript Script)
    {
        Init(Script);

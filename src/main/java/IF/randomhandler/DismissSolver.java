...
public class DismissSolver extends RandomSolver
{
    ...
    public boolean shouldExecute()
    {
        ...
        return (Players.getLocal().getInteractingCharacter() != null &&
                lstRandoms.contains(Players.getLocal().getInteractingCharacter().getName())) ||
               (random != null && random.getInteractingCharacter() != null &&
                random.getInteractingCharacter().equals(Players.getLocal()));
    }

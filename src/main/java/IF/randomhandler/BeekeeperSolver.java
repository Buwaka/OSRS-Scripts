...
public class BeekeeperSolver extends RandomSolver
{
    ...
    public boolean shouldExecute()
    {
        ...
        return beeKeeper != null && beeKeeper.getInteractingCharacter() != null &&
               beeKeeper.getInteractingCharacter().equals(Players.getLocal());
    }
    ...
    public int onLoop()
    {
        ...
        if(NPCs.closest(beekeeperOverworld) != null)
        {
            ...
            if(/*!areaHives.contains(Players.getLocal().getTile())*/
                    NPCs.closest(beekeeperInstance) == null && beeKeeper.interact())
            {
            ...
            if(/*!areaHives.contains(Players.getLocal().getTile())*/
                    NPCs.closest(beekeeperInstance) == null && Dialogues.inDialogue())
            {
                Sleep.sleep(1350, 2850);
                if(Dialogues.getOptionIndexContaining("Ooh") > -1)
                {
        ...
        if(NPCs.closest(beekeeperInstance) != null &&
           Widgets.getWidget(WIDGET) == null/*areaHives.contains(Players.getLocal().getTile())*/)
        {
                ...
                if(object != null)
                {
                    for(int part : parts)
                    {
                        if(object.getDisabledMediaID() == part)
                        {
                            ...
                            List<WidgetChild> widgetChildrenContainingText = Widgets.getWidgetChildrenContainingText(
                                    place);

...
public class FrogSolver extends RandomSolver
{
    ...
    public boolean shouldExecute()
    {
        ...
        return (froggyFrog != null && froggyFrog.getInteractingCharacter() != null &&
                froggyFrog.getInteractingCharacter().equals(Players.getLocal())) ||
               (froggyPrince != null && froggyPrince.getInteractingCharacter() != null &&
                froggyPrince.getInteractingCharacter().equals(Players.getLocal()));
    }

package IF.Utilities.GrandExchange;

import IF.Utilities.GrandExchange.Orders.BaseOrder;
...
public class GEInstance implements Serializable
{
    ...
    private transient       IScript               OwnerScript;

    public GEInstance(IScript owner)
    {
        init(owner);
    }

    public void init(IScript owner)
    {
        OwnerScript = owner;

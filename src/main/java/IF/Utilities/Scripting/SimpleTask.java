...
public abstract class SimpleTask implements ITask
{
    ...
    public transient  Delegate1<ITask>        onReplaced        = new Delegate1<>();
     ...
     */
    public void Init(IScript Script)
    {
     ...
     */
    public final boolean PauseTask(IScript Script)
    {
        Paused = true;
     ...
     * @return return true if successfully paused, otherwise false
     */
    public final boolean UnPauseTask(IScript Script)
    {
        Paused = false;
    ...
    public final void ReplaceTask(IScript Script, ITask other)
    {
     ...
     */
    public void onReplaced(IScript Script, ITask other) {}
     ...
     */
    @Override
    public final boolean StartTask(IScript Script)
    {
        Active = true;
     ...
     * @return return true if successful, false if we need more time, keep triggering start until it is ready
     */
    public final boolean StopTask(IScript Script)
    {
    ...
    @Override
    public final void StopTaskNOW(IScript Script)
    {
        onStopTask(Script);
        Active   = false;
        Finished = true;

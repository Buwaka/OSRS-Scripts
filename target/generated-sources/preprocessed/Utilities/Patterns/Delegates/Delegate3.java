...
import Utilities.Patterns.Runables.Runable3;
...
{
    WeakHashMap<Object, Runable3<A, B, C>> Subscribers = new WeakHashMap<>();
    ...
    public void Subscribe(Object caller, Runable3<A, B, C> function)
    {

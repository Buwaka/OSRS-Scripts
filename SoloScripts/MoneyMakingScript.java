...
public class MoneyMakingScript extends tpircSScript
{
    ...
    SimpleProcessCycle TanLeather = new SimpleProcessCycle("Tan HardLeather", new TanTask("HardLeather", "Hard leather",
                                                                                          ItemDB.GetClosestMatch("Cowhide", true).id), new Area(3278, 3193, 3283, 3189));
...
//            var           equipment    = MeleeCombat.GetWeaponOnly();

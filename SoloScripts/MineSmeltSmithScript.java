...
//        SmithAdamaniteHelm.Requirement = () -> Skills.getRealLevel(Skill.SMITHING) >= 63;
...
//        AddCycle(SmithAdamanitePlateBody);
        ...
        SmithMithrilSword.Requirement = () -> Skills.getRealLevel(Skill.SMITHING) >= 54;
        SmithMithrilSword.Goal = () -> Bank.count(MithrilBar) == 0 || Skills.getRealLevel(Skill.SMITHING) >= 63;
        ...
        CoalCycle.Goal = () -> {
            ...
            return Bank.isCached() && Bank.count(453) > 400;
        };
        AddCycle(CoalCycle);

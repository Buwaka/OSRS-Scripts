...
public class CycleLibrary
{
    ...
    public static String GenerateJSONSmeltCycles()
    {
        ...
        SmeltCycle SmeltBluerite = new SmeltCycle("Smelt Blurite", "Blurite bar", new Tuple2<>(BlueriteOre, 1));
        ...
        SmeltCycle SmeltSilver = new SmeltCycle("Smelt Silver", "Silver bar", new Tuple2<>(SilverOre, 1));

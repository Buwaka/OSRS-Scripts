...
@ScriptManifest(name = "ClayFiringScript", description = "Pottery Crafting Script, Varrock west bank to barbarian klin", author = "Semanresu",
        version = 1.0, category = Category.CRAFTING, image = "")
public class ClayFiringScript  extends AbstractScript{
